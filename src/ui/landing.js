const CONTENT = {
  brand: "Portfolio CMS Headless",
  strap: "content operations",
  subtitle: "Backend editorial para projetos e posts com fluxo admin e preview controlado.",
  accent: "#ffd46f",
  ctaPrimary: "Status do servico",
  ctaSecondary: "Rotas publicas",
  apiTitle: "CMS endpoints",
  featuresHtml: `<li><span>01</span><strong>CRUD admin para projetos e artigos com slug unico.</strong></li><li><span>02</span><strong>Preview token com TTL e revogacao para revisar rascunhos com seguranca.</strong></li><li><span>03</span><strong>API publica enxuta para consumir conteudo publicado no frontend.</strong></li>`,
  endpointsHtml: `<li><span class="method">GET</span><span class="path">/health</span></li><li><span class="method">POST</span><span class="path">/admin/login</span></li><li><span class="method">POST</span><span class="path">/admin/projects</span></li><li><span class="method">POST</span><span class="path">/admin/posts</span></li><li><span class="method">GET</span><span class="path">/api/projects</span></li><li><span class="method">GET</span><span class="path">/api/posts</span></li>`,
}
